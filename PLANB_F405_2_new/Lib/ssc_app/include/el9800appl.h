...
typedef struct OBJ_STRUCT_PACKED_START
{
   ...
   UINT32 aEntries[29]; /**< \brief Entry buffer*/
...
#ifdef _EVALBOARD_
    = {29, {0x70100101, 0x70100201, 0x70100301, 0x70100401, 0x70100501, 0x70100601, 0x70100701, 0x70100801, 0x70100908, /*can2*/ 0x70101010, 0x70101108, 0x70101208, 0x70101308, 0x70101408, 0x70101508, 0x70101608, 0x70101708, 0x70101808, 0x70101908, 0x70102008, 0x70102108, 0x70102208 /*motor1*/, 0x70102310, 0x70102420, 0x70102520, 0x70102620, 0x70102720, 0x70102820, 0x70102910}}
#endif
;
/** @}*/
...
#ifdef _EVALBOARD_
    = {29, {0x60200101, 0x60200201, 0x60200302, 0x60200502, 0x08, 0x18020701, 0x18020901, 0x60201110/*can2*/, 0x60201210, 0x60201308, 0x60201408, 0x60201508, 0x60201608, 0x60201708, 0x60201808, 0x60201908, 0x60202008, 0x60202108, 0x60202208, 0x60202308, 0x60202408/*motor*/, 0x60202510, 0x60202608, 0x60202708, 0x60202820, 0x60202920, 0x60203020, 0x60203110, 0x60203210}}
#endif
;
/** @}*/
...
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x6020[] = {
    ...
    /*can2*/
    {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    ...
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x08, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x20, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x20, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x20, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
    {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING},
 ...
 */
OBJCONST UCHAR OBJMEM aName0x6020[] = "AI Inputs\000Underrange\000Overrange\000Limit 1\000\000Limit 2\000\000\000\000\000\000\000\000\000\000TxPDO State\000TxPDO Toggle\000Analog input\000can2_h0\000can2_h1\000can2_h2\000can2_h3\000can2_h4\000can2_d0\000can2_d1\000can2_d2\000can2_d3\000can2_d4\000can2_d5\000can2_d6\000can2_d7\000motor_mode\000motor_temp\000motor_error\000motor_t\000motor_w\000motor_pos\000motor_acc\000motor_id\000\377";
#endif // #ifdef _OBJD_
...
#ifdef _EVALBOARD_
    = {38, 0x00, 0x00, 0x00, 0x00, 0, 0, 0x00, 0x00, 0x7FFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
#endif
;
...
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x7010[] = {
    ...
    {DEFTYPE_BOOLEAN, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    /*can2*/
    {DEFTYPE_BOOLEAN, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x08, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    ...
    /*motor*/
    {DEFTYPE_BOOLEAN, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_BOOLEAN, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING},
 ...
 * \brief 0x6000 (Digital input object) object and entry names
 */
OBJCONST UCHAR OBJMEM aName0x7010[] = "DO Outputs\000LED 1\000LED 2\000LED 3\000LED 4\000LED 5\000LED 6\000LED 7\000LED 8\000null\000can2_h0\000can2_h1\000can2_h2\000can2_h3\000can2_h4\000can2_d0\000can2_d1\000can2_d2\000can2_d3\000can2_d4\000can2_d5\000can2_d6\000can2_d7\000motor_mode\000motor_pos\000motor_w\000motor_kp\000motor_kd\000motor_t\000motor_id\000\000\377";
#endif // #ifdef _OBJD_
...
#ifdef _EVALBOARD_
    = {29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
#endif
;
/** @}*/
...
TOBJECT OBJMEM ApplicationObjDic[] = {
    ...
    /* Object 0x1601 */
    {NULL, NULL, 0x1601, {DEFTYPE_PDOMAPPING, 29 | (OBJCODE_REC << 8)}, asEntryDesc0x1601, aName0x1601, &sDORxPDOMap, NULL, NULL, 0x0000},
    /* Object 0x1802 */
    ...
    /* Object 0x1A02 */
    {NULL, NULL, 0x1A02, {DEFTYPE_PDOMAPPING, 29 | (OBJCODE_REC << 8)}, asEntryDesc0x1A02, aName0x1A02, &sAITxPDOMap, NULL, NULL, 0x0000},
    /* Object 0x1C12 */
    ...
    /* Object 0x6020 */
    {NULL, NULL, 0x6020, {DEFTYPE_RECORD, 38 | (OBJCODE_REC << 8)}, asEntryDesc0x6020, aName0x6020, &sAIInputs, NULL, NULL, 0x0000},
    /* Object 0x7010 */
    {NULL, NULL, 0x7010, {DEFTYPE_RECORD, 29 | (OBJCODE_REC << 8)}, asEntryDesc0x7010, aName0x7010, &sDOOutputs, NULL, NULL, 0x0000},
    /* Object 0x8020 */
